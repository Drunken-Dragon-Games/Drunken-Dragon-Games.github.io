...
var $author$project$Main$saturnBuyClicked = _Platform_outgoingPort('saturnBuyClicked', $elm$json$Json$Encode$string);
	...
	function (msg, model) {
		switch (msg.$) {
			case 'BuySlime':
				return _Utils_Tuple2(
					model,
					$author$project$Main$saturnBuyClicked('519592d1-0c0e-4203-b296-2280c93adecc'));
			case 'CollectionMsg':
				var subMsg = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$BuySlime = {$: 'BuySlime'};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src('https://saturn-production.nyc3.digitaloceanspaces.com/Payment/Buttons/SaturnPayment323.png'),
										A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
										$elm$html$Html$Events$onClick($author$project$Main$BuySlime)
									]),
								_List_Nil)
							]))
					])),
